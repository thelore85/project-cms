  ...
  return (
    <section id="valueProposition" className="bg-background">
      <div className="container my-20">
        ...
        {/* TABS  */}
        <div className="flex justify-between bg-white rounded-full border-2 border-black mb-5 px-64 py-2">
          <div className=" bg-primary text-center opacity-75 rounded-3xl p-3 text-primary-foreground text-xl w-40 cursor-pointer">Vende</div>
          <div className="bg-background text-center rounded-3xl p-3 text-foreground text-xl w-40 cursor-pointer">Gestiona</div>
          <div className="bg-background text-center rounded-3xl p-3 text-foreground text-xl w-40 cursor-pointer">Crece</div>
        </div>
        {/* CARD  */}
